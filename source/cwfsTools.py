...
def ZernikeGrad(Z, x, y, atype):
    ...
    if (atype == 'dx'):
        ...
        d = d + Z[15] * np.sqrt(12) * (x2 * (50.0 * x2 +
                                             60.0 * y2 - 36.0) + y2 * (10.0 * y2 - 12.0) + 3)
        d = d + Z[16] * np.sqrt(12) * (xy * (40.0 * r2 - 24.0))
        d = d + Z[17] * np.sqrt(12) * (x2 * (25.0 * x2 -
                                             12.0 - 30.0 * y2) + y2 * (12.0 - 15.0 * y2))
        d = d + Z[18] * np.sqrt(12) * (4.0 * xy *
                                       (-6.0 + 15.0 * x2 + 5.0 * y2))
        d = d + Z[19] * np.sqrt(12) * 5 * (x2 * (x2 - 6 * y2) + y2 * y2)
        d = d + Z[20] * np.sqrt(12) * 20 * xy * (x2 - y2)
        d = d + Z[21] * np.sqrt(7) * 24 * x * (1 + x2 *
                                               (10 * y2 - 5 + 5 * x2) + y2 * (5 * y2 - 5))
        ...
        d = d + Z[16] * np.sqrt(12) * (x2 * (10.0 * x2 +
                                             60.0 * y2 - 12.0) + y2 * (50.0 * y2 - 36.0) + 3)
        d = d + Z[17] * np.sqrt(12) * (4.0 * xy * (6.0 - 5.0 * x2 - 15.0 * y2))
        d = d + Z[18] * np.sqrt(12) * (y2 * (-25.0 * y2 +
                                             12.0 + 30.0 * x2) + x2 * (-12.0 + 15.0 * x2))
        d = d + Z[19] * np.sqrt(12) * 20 * xy * (y2 - x2)
        d = d + Z[20] * np.sqrt(12) * 5 * (x2 * (x2 - 6 * y2) + y2 * y2)
        d = d + Z[21] * np.sqrt(7) * 24 * y * (1 + y2 *
                                               (10 * x2 - 5 + 5 * y2) + x2 * (5 * x2 - 5))
...
def ZernikeJacobian(Z, x, y, atype):
    ...
    if (atype == '1st'):
        ...
        j = j + Z[21] * np.sqrt(7) * 48 * (1 + x2 *
                                           (30 * y2 + 15 * x2 - 10) + y2 * (15 * y2 - 10))
        ...
        j = j + Z[17]**2 * (12) * 16.0 * (x2 * (-36.0 + 360 * y2 + x2 * (
            180 - 1275 * y2 - 125 * x2)) + y2 * (-36 + y2 * (180 + 225 * (x2 - y2))))
        j = j + Z[18]**2 * (12) * 16.0 * (y2 * (-36.0 + 360 * x2 + y2 * (
            180 - 1275 * x2 - 125 * y2)) + x2 * (-36 + x2 * (180 + 225 * (y2 - x2))))
        j = j + Z[19]**2 * (12) * (-400) * r2**3
        j = j + Z[20]**2 * (12) * (-400) * r2**3
        j = j + Z[21]**2 * (7) * 576 * (1 + x2 * (10 * y2 + 5 * x2 - 5) + y2 * (
            5 * y2 - 5)) * (1 + x2 * (25 * x2 + 50 * y2 - 15) + y2 * (25 * y2 - 15))
...
def ZernikeAnnularJacobian(Z, x, y, e, atype):
    ...
    if (atype == '1st'):
        ...
        num = np.sqrt((1 - e2)**2 * (1 + 4 * e2 + e4) /
                      (1 + 9 * e2 + 9 * e4 + e6))
        j = j + Z[15] * np.sqrt(12) * 48 * x * (5 * r2 * (1 + 4 *
                                                          e2 + e4) - 2 * (1 + 4 * e2 + 4 * e4 + e6)) * num / den
        j = j + Z[16] * np.sqrt(12) * 48 * y * (5 * r2 * (1 + 4 *
                                                          e2 + e4) - 2 * (1 + 4 * e2 + 4 * e4 + e6)) * num / den
        den = (1 - e2)**4 * (1 + e2) * (1 + e4)
        num = np.sqrt((1 - e2)**6 * (1 + e2) * (1 + e4) /
                      (1 + 4 * e2 + 10 * e4 + 20 * e6 + 10 * e8 + 4 * e10 + e12))
        ...
        j = j + Z[20] * np.sqrt(12) * 0
        den = (1 - e2)**3
        j = j + Z[21] * np.sqrt(7) * 48 * (e4 - 10 * e2 * x2 - 10 * e2 * y2 +
                                           3 * e2 + 15 * x4 + 30 * x2 * y2 - 10 * x2 + 15 * y4 - 10 * y2 + 1) / den
    elif (atype == '2nd'):
        ...
        num = ((1 - e2)**4 * (1 + e2 + e4) /
               (1 + 4 * e2 + 10 * e4 + 4 * e6 + e8))
        j = j + Z[11]**2 * (10) * 36 * (8 * (1 + e2 + e4) * x2 - 1 - e2 -
                                        e4 - e6) * (1 + e2 + e4 + e6 - 8 * (1 + e2 + e4) * y2) * num / den
        j = j + Z[12]**2 * (10) * 36 * (-4 * (x - y)**2 * (e4 + e2 + 1) + 1 + e2 +
                                        e4 + e6) * (4 * (x + y)**2 * (e4 + e2 + 1) - 1 - e2 - e4 - e6) * num / den
        den = (1 + e2 + e4 + e6 + e8)
        ...
        j = j + Z[17]**2 * (12) * 16.0 * (- 36 * e16 * x2 - 36 * e16 * y2 + 180 * e14 * x4 + 360 * e14 * x2 * y2 - 72 * e14 * x2
                                          + 180 * e14 * y4 - 72 * e14 * y2 - 125 * e12 * x6 - 1275 *
                                          e12 * x4 * y2 + 360 * e12 * x4 + 225 * e12 * x2 * y4
...
def poly10_2D(c, data, y=None):
    ...
    F = c[0] + c[1] * x + c[2] * y + c[3] * x * x + c[4] * x * y + c[5] * y * y \
        ...
        + c[55] * x**10 + c[56] * x**9 * y + c[57] * x**8 * y**2 + c[58] * x**7 * y**3 + c[59] * x**6 * y**4 + c[60] * \
        x**5 * y**5 + c[61] * x**4 * y**6 + c[62] * x**3 * y**7 + \
        c[63] * x**2 * y**8 + c[64] * x * y**9 + c[65] * y**10
...
def poly10Grad(c, x, y, atype):
    ...
    if (atype == 'dx'):
        out = c[1] + c[3] * 2 * x + c[4] * y + c[6] * 3 * x**2 + c[7] * 2 * x * y + c[8] * y**2 + \
            ...
            + c[55] * 10 * x**9 + c[56] * 9 * x**8 * y + c[57] * 8 * x**7 * y**2 + c[58] * 7 * x**6 * y**3 + c[59] * 6 * x**5 * \
            y**4 + c[60] * 5 * x**4 * y**5 + c[61] * 4 * x**3 * y**6 + \
        ...
        out = c[2] + c[4] * x + c[5] * 2 * y + c[7] * x**2 + c[8] * x * 2 * y + c[9] * 3 * y**2  \
            ...
            + c[56] * x**9 + c[57] * x**8 * 2 * y + c[58] * x**7 * 3 * y**2 + c[59] * x**6 * 4 * y**3 + c[60] * x**5 * 5 * y**4 + \
            c[61] * x**4 * 6 * y**5 + c[62] * x**3 * 7 * y**6 + c[63] * \
            x**2 * 8 * y**7 + c[64] * x * 9 * y**8 + c[65] * 10 * y**9
...
def ZernikeAnnularEval(Z, x, y, e):
    ...
    num = np.sqrt((1 - e2)**4 * (1 + e2 + e4) /
                  (1 + 4 * e2 + 10 * e4 + 4 * e6 + e8))
    S = S + Z[11] * np.sqrt(10) * (4 * r4 - 3 * r2 - 3 * e6 * r2 -
                                   e2 * r2 * (3 - 4 * r2) - e4 * r2 * (3 - 4 * r2)) * c2 * num / den
    S = S + Z[12] * np.sqrt(10) * (4 * r4 - 3 * r2 - 3 * e6 * r2 -
                                   e2 * r2 * (3 - 4 * r2) - e4 * r2 * (3 - 4 * r2)) * s2 * num / den
    ...
    numE = np.sqrt((1 - e2)**2 * (1 + 4 * e2 + e4) /
                   (1 + 9 * e2 + 9 * e4 + e6))
    numQ = 10 * r5 - 12 * r3 + 3 * r + 3 * e8 * r - 12 * e6 * r * \
        (r2 - 1) + 2 * e4 * r * (15 - 24 * r2 + 5 * r4) + \
    ...
    den = (1 - e2)**3
    S = S + Z[21] * np.sqrt(7) * (20 * r6 - 30 * r4 + 12 * r2 - 1 - e6 +
