...
def ZernikeAnnularGrad( Z, x, y ,e, type):
    ...
    if (type== 'dx'):
        ...
        d =  d + Z[7]  * np.sqrt( 8 )  * ((9 * x2 + 3 * y2 - 2)*(1+e2)-2*e4)/den
        ...
        d =  d + Z[11] * np.sqrt( 10 ) * (x* (16 * x2 - 6)*(1+e2+e4)-6*x*e6)*num/den
        d =  d + Z[12] * np.sqrt( 10 ) * (y* (24 * x2 + 8 * y2 - 6)*(1+e2+e4)-6*y*e6)*num/den
        den=np.sqrt(1+e2+e4+e6+e8)
        d =  d + Z[13] * np.sqrt( 10 ) * 4 * x* (x2 - 3 * y2)/den
        d =  d + Z[14] * np.sqrt( 10 ) * 4 * y* (3 * x2 - y2)/den
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        d =  d + Z[15] * np.sqrt( 12 ) * (3*e8 - 36*e6*x2 - 12*e6*y2 + 12*e6 + 50*e4*x4 + 60*e4*x2*y2 - 144*e4*x2 \
        ...
        d =  d + Z[16] * np.sqrt( 12 ) * (8*xy* (5*r2*(1+4*e2+e4)-(3+12*e2+12*e4+3*e6) ))*num/den
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))
        d =  d + Z[17] * np.sqrt( 12 ) * (25*(e6 + e4 + e2 +1)*x4 + (- 12*e8 - 30*e6*y2 - 12*e6 - 30*e4*y2 - 12*e4\
                                                                    - 30*e2*y2 - 12*e2 - 30*y2 - 12)*x2 + 12*e8*y2 - 15*e6*y4 + 12*e6*y2 - 15*e4*y4 + 12*e4*y2 \
                                       - 15*e2*y4 + 12*e2*y2 - 15*y4 + 12*y2 )*num/den
        d =  d + Z[18] * np.sqrt( 12 ) * (4.0*xy*(15*(e6+e4+e2+1)*x2 - 6*e8 + 5*e6*y2 - 6*e6 + 5*e4*y2 - 6*e4 + 5*e2*y2\
                                                - 6*e2 + 5*y2 - 6 ))*num/den
        den=np.sqrt(1+e2+e4+e6+e8+e10)
        d =  d + Z[19] * np.sqrt( 12 ) * 5*(x2*(x2-6*y2)+y4)/den
        d =  d + Z[20] * np.sqrt( 12 ) * 20*xy*(x2-y2)/den
        den=(1-e2)**3
        d =  d + Z[21] * np.sqrt(  7 )  * 24*x*(e4 - e2*(5*y2-3) + 5*x4 - 5*y2 + 5*y4 - x2*(5*e2 - 10*y2 + 5) + 1)/den
    elif (type == 'dy'):
        d =        Z[0]  * 0 * x
        den=np.sqrt(1+e2)
        d =  d + Z[1]  * 2 * 0
        ...
        den=np.sqrt( (1-e2)**2*(1+e2)*(1+4*e2+e4) )
        d =  d + Z[6]  * np.sqrt( 8 )  * ((1+e2)*(3 * x2 + 9 * y2 - 2) -2*e4)/den
        ...
        den=(1-e2)**3*(1+e2+e4)
        num=np.sqrt((1-e2)**4*(1+e2+e4)/(1+4*e2+10*e4+4*e6+e8))
        d =  d + Z[11] * np.sqrt( 10 ) * (y* (6 - 16 * y2)*(1+e2+e4)+6*y*e6)*num/den
        d =  d + Z[12] * np.sqrt( 10 ) * (x* (8 * x2 + 24 * y2 - 6)*(1+e2+e4)-6*x*e6)*num/den
        den=np.sqrt(1+e2+e4+e6+e8)
        d =  d + Z[13] * np.sqrt( 10 ) * 4 * y* (y2 - 3 * x2)/den
        d =  d + Z[14] * np.sqrt( 10 ) * 4 * x* (x2 - 3 * y2)/den
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        d =  d + Z[15] * np.sqrt( 12 ) * (-x*(24*y + 4*e2*(24*y - 40*y*r2) + 2*e4*(48*y - 20*y*r2) + 24*e6*y - 40*y*r2))*num/den
        d =  d + Z[16] * np.sqrt( 12 ) * (3*e8 - 12*e6*x2 - 36*e6*y2 + 12*e6 + 10*e4*x4 + 60*e4*x2*y2 - 48*e4*x2 \
        ...
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))    
        d =  d + Z[17] * np.sqrt( 12 ) * (4.0*xy*((- 5)*(e6 +e4+ e2 +1)*x2 + 6*e8 - 15*e6*y2 + 6*e6 - 15*e4*y2\
                                                + 6*e4 - 15*e2*y2 + 6*e2 - 15*y2 + 6))*num/den
        d =  d + Z[18] * np.sqrt( 12 ) * (- 12*e8*x2 + 12*e8*y2 + 15*e6*x4 + 30*e6*x2*y2 - 12*e6*x2 - 25*e6*y4\
        ...
        den=(1-e2)**3
        d =  d + Z[21] * np.sqrt(  7 )  * 24*y*(e4 - e2*(5*x2 - 3) - 5*x2 + 5*x4 + 5*y4 - y2*(5*e2 - 10*x2 + 5) + 1)/den
    elif (type == 'dx2'):
        d =        Z[0]  * 0 * x # to make d an array with the same size as x 
        d =  d + Z[1]  * 0
        d =  d + Z[2]  * 0
        ...
        den=(1-e2)**3*(1+e2+e4)
        num=np.sqrt((1-e2)**4*(1+e2+e4)/(1+4*e2+10*e4+4*e6+e8))
        d =  d + Z[11] * np.sqrt( 10 ) * ((48 * x2 - 6)*(1+e2+e4)-6*e6)*num/den
        ...
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        d =  d + Z[15] * np.sqrt( 12 ) * (-8*x*(9*e6 - 25*e4*x2 - 15*e4*y2 + 36*e4 - 100*e2*x2 \
                                              - 60*e2*y2 + 36*e2 - 25*x2 - 15*y2 + 9))*num/den
        d =  d + Z[16] * np.sqrt( 12 ) * (-8*y*(3*e6 - 15*e4*x2 - 5*e4*y2 + 12*e4 - 60*e2*x2\
                                              - 20*e2*y2 + 12*e2 - 15*x2 - 5*y2 + 3) )*num/den
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))
        d =  d + Z[17] * np.sqrt( 12 ) * ( -4*x*(6*e8 - 25*e6*x2 + 15*e6*y2 + 6*e6 - 25*e4*x2 \
                                               + 15*e4*y2 + 6*e4 - 25*e2*x2 + 15*e2*y2 + 6*e2 - 25*x2 + 15*y2 + 6))*num/den
        d =  d + Z[18] * np.sqrt( 12 ) * (-4*y*(6*e8 - 45*e6*x2 - 5*e6*y2 + 6*e6 - 45*e4*x2 \
        ...
        den=(1-e2)**3
        d =  d + Z[21] * np.sqrt(  7 )  * (480*x2*r2 + 120*r4 + 24*e4 - 360*x2 - 120*y2 \
        ...
        den=(1-e2)**3*(1+e2+e4)
        num=np.sqrt((1-e2)**4*(1+e2+e4)/(1+4*e2+10*e4+4*e6+e8))
        d =  d + Z[11] * np.sqrt( 10 ) * ((6 - 48 * y2)*(1+e2+e4)+6*e6)*num/den
        d =  d + Z[12] * np.sqrt( 10 ) * 48 * xy*(1+e2+e4)*num/den
        den=np.sqrt(1+e2+e4+e6+e8)
        ...
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        d =  d + Z[15] * np.sqrt( 12 ) * (-8*x*(3*e6 - 5*e4*x2 - 15*e4*y2 + 12*e4 - 20*e2*x2\
                                              - 60*e2*y2 + 12*e2 - 5*x2 - 15*y2 + 3) ) *num/den
        d =  d + Z[16] * np.sqrt( 12 ) * (-8*y*(9*e6 - 15*e4*x2 - 25*e4*y2 + 36*e4 - 60*e2*x2\
                                              - 100*e2*y2 + 36*e2 - 15*x2 - 25*y2 + 9))*num/den
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))    
        d =  d + Z[17] * np.sqrt( 12 ) * (4*x*(6*e8 - 5*e6*x2 - 45*e6*y2 + 6*e6 - 5*e4*x2\
                                             - 45*e4*y2 + 6*e4 - 5*e2*x2 - 45*e2*y2 + 6*e2 - 5*x2 - 45*y2 + 6))*num/den
        d =  d + Z[18] * np.sqrt( 12 ) * (4*y*(6*e8 + 15*e6*x2 - 25*e6*y2 + 6*e6 + 15*e4*x2 \
        ...
        den=(1-e2)**3
        d =  d + Z[21] * np.sqrt(  7 )  * (480*y2*r2 + 120*r4 + 24*e4 - 120*x2 - 360*y2 \
        ...
        d =  d + Z[12] * np.sqrt( 10 ) * ((24 * x2 + 24 * y2 - 6)*(1+e2+e4)-6*e6)*num/den
        den=np.sqrt(1+e2+e4+e6+e8)
        d =  d + Z[13] * np.sqrt( 10 ) * (-24)*xy/den
        d =  d + Z[14] * np.sqrt( 10 ) * 12 *  (x2 - y2)/den
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        d =  d + Z[15] * np.sqrt( 12 ) * (-8*y*(3*e6 - 15*e4*x2 - 5*e4*y2 + 12*e4 - 60*e2*x2\
                                              - 20*e2*y2 + 12*e2 - 15*x2 - 5*y2 + 3))*num/den
        d =  d + Z[16] * np.sqrt( 12 ) * (-8*x*(3*e6 - 5*e4*x2 - 15*e4*y2 + 12*e4 - 20*e2*x2\
                                              - 60*e2*y2 + 12*e2 - 5*x2 - 15*y2 + 3) )*num/den
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))    
        d =  d + Z[17] * np.sqrt( 12 ) * (12*y*(2*e8 - 5*e6*r2 + 2*e6 - 5*e4*r2 + 2*e4\
                                              - 5*e2*r2 + 2*e2 - 5*r2 + 2))*num/den
        d =  d + Z[18] * np.sqrt( 12 ) * (-12*x*(2*e8 - 5*e6*r2 + 2*e6 - 5*e4*r2 + 2*e4 \
                                               - 5*e2*r2 + 2*e2 - 5*r2 + 2) )*num/den
        den=np.sqrt(1+e2+e4+e6+e8+e10)
...
def ZernikeAnnularJacobian(Z, x, y , e, atype):
    ...
    if (atype == '1st'):
        ...
        den=(1-e2)**3*(1+e2+e4)
        num=np.sqrt((1-e2)**4*(1+e2+e4)/(1+4*e2+10*e4+4*e6+e8))
        j =  j + Z[11] * np.sqrt( 10 ) * 48 * (x2 - y2)*(1+e2+e4)*num/den 
        j =  j + Z[12] * np.sqrt( 10 ) * 96 * xy*(1+e2+e4)*num/den
        j =  j + Z[13] * np.sqrt( 10 ) * 0
        j =  j + Z[14] * np.sqrt( 10 ) * 0
        den=(1-e2)**3*(1+4*e2+e4)
        num=np.sqrt((1-e2)**2*(1+4*e2+e4)/(1+9*e2+9*e4+e6) )
        j =  j + Z[15] * np.sqrt( 12 ) * 48*x*(5*r2*(1+4*e2+e4)-2*(1+4*e2+4*e4+e6))*num/den
        j =  j + Z[16] * np.sqrt( 12 ) * 48*y*(5*r2*(1+4*e2+e4)-2*(1+4*e2+4*e4+e6))*num/den
        den=(1-e2)**4*(1+e2)*(1+e4)
        num=np.sqrt((1-e2)**6*(1+e2)*(1+e4)/(1+4*e2+10*e4+20*e6+10*e8+4*e10+e12))    
        j =  j + Z[17] * np.sqrt( 12 ) * 80.0*x*(x2-3.0*y2)*(1+e2)*(1+e4)*num/den
        j =  j + Z[18] * np.sqrt( 12 ) * 80.0*y*(3*x2-y2)*(1+e2)*(1+e4)*num/den
        j =  j + Z[19] * np.sqrt( 12 ) * 0
        j =  j + Z[20] * np.sqrt( 12 ) * 0
        den=(1-e2)**3
        j =  j + Z[21] * np.sqrt(  7 )  * 48*(e4 -10*e2*x2 - 10*e2*y2 + 3*e2 + 15*x4 + 30*x2*y2- 10*x2 +15*y4-10*y2+1)/den
    elif (atype =='2nd'):
